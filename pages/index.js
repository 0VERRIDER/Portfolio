  ...
  return (
    ...
    <div className={styles.title}>
      ...
      <span className={styles.description}>
        ...
        <li className={`${skillSlide==3?styles.slideUp:''}`}>Programmer</li>
        <li className={`${skillSlide==2?styles.slideUp:''}`}>Problem solver</li>
        </ul>
        </span>
    </div>
    ...
    <div className={styles.Title}>Skills</div>
      ...
      <div className={styles.skillBox}>
        ...
        <Image src="/images/skills/aws.svg" width={50} height={50} alt="aws"></Image>
        </div>
      </div>
      <div className={styles.skillBox}>
      <div className={styles.skillImage}>
        <Image src="/images/skills/firebase.svg" width={50} height={50} alt="firebase"></Image>
        </div>
      </div>
      <div className={styles.skillBox}>
      <div className={styles.skillImage}>
        <Image src="/images/skills/docker.svg" width={50} height={50} alt="docker"></Image>
        </div>
      </div>
      <div className={styles.skillBox}>
      <div className={styles.skillImage}>
        <Image src="/images/skills/figma.svg" width={50} height={50} alt="figma"></Image>
        </div>
      </div>
      <div className={styles.skillBox}>
      <div className={styles.skillImage}>
        <Image src="/images/skills/js.svg" width={50} height={50} alt="js"></Image>
        </div>
      </div>
      <div className={styles.skillBox}>
      <div className={styles.skillImage}>
        <Image src="/images/skills/mongo.svg" width={50} height={50} alt="mongodb"></Image>
        </div></div>     
      <div className={styles.skillBox}>
      <div className={styles.skillImage}>
        <Image src="/images/skills/php.svg" width={50} height={50} alt="php"></Image>
        </div>
      </div>
      <div className={styles.skillBox}>
      <div className={styles.skillImage}>
        <Image src="/images/skills/python.svg" width={50} height={50} alt="python"></Image>
        </div>
      </div>
      <div className={styles.skillBox}>
      <div className={styles.skillImage}>
        <Image src="/images/skills/react.svg" width={50} height={50} alt="react"></Image>
        </div>
      </div>
      <div className={styles.skillBox}>
      <div className={styles.skillImage}>
        <Image src="/images/skills/sass.svg" width={50} height={50} alt="sass"></Image>
        </div>
      </div>
      <div className={styles.skillBox}>
      <div className={styles.skillImage}>
        <Image src="/images/skills/cpp.png" width={50} height={50}  alt="cpp" ></Image>
        </div>
      </div>
      <div className={styles.skillBox}>
      <div className={styles.skillImage}>
        <Image src="/images/skills/androidStudio.png" width={50} height={50}  alt="androidStudio" ></Image>
        </div>
        </div> 
      <div className={styles.skillBox}>
      <div className={styles.skillImage}>
        <Image src="/images/skills/flutter.png" width={50} height={50}  alt="flutter" ></Image>
        </div>
      </div>
      <div className={styles.skillBox}>
      <div className={styles.skillImage}>
        <Image src="/images/skills/kotlin.png" width={50} height={50}  alt="kotlin" ></Image>
        </div>
      </div>
      <div className={styles.skillBox}>
      <div className={styles.skillImage}>
        <Image src="/images/skills/azure.png" width={50} height={50}  alt="azure" ></Image>
        </div>
      </div>
      <div className={styles.skillBox}>
      <div className={styles.skillImage}>
        <Image src="/images/skills/nextjs.svg" width={50} height={50}  alt="nextjs" ></Image>
        </div>
      </div>
      <div className={styles.skillBox}>
      <div className={styles.skillImage}>
        <Image src="/images/skills/gcp.png" width={40} height={30}  alt="gcp" ></Image>
        </div>
      </div>
      <div className={styles.skillBox}>
      <div className={styles.skillImage}>
        <Image src="/images/skills/css3.png" width={50} height={50}  alt="css3" ></Image>
        </div>
        </div>     
      <div className={styles.skillBox}>
      <div className={styles.skillImage}>
        <Image src="/images/skills/java.png" width={50} height={50}  alt="java" ></Image>
        </div>
      </div>
      <div className={styles.skillBox}>
      <div className={styles.skillImage}>
        <Image src="/images/skills/github.png" width={50} height={50}  alt="github" ></Image>
        </div>
      </div>
      <div className={styles.skillBox}>
      <div className={styles.skillImage}>
        <Image src="/images/skills/mysql.png" width={50} height={50}  alt="mysql" ></Image>
        </div>
      </div>
      <div className={styles.skillBox}>
      <div className={styles.skillImage}>
        <Image src="/images/skills/angular.png" width={50} height={50}  alt="angular" ></Image>
        </div>
      </div>
      <div className={styles.skillBox}>
      <div className={styles.skillImage}>
        <Image src="/images/skills/bootstrap.svg" width={50} height={50}  alt="bootstrap" ></Image>
        </div>
      </div>
      <div className={styles.skillBox}>
      <div className={styles.skillImage}>
        <Image src="/images/skills/tailwind.png" width={50} height={50}  alt="tailwind" ></Image>
        </div>
        </div> 
