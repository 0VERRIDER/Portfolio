...
export default function LogoLined(props) {
    ...
    useEffect(() => {
        const toggleAnimation = () => {
            setAnimation((prev) => (prev === "moved" ? "" : "moved"));
        }

        const timeout = setTimeout(toggleAnimation, 300);
    ...
    return (
        ...
        >
            <g stroke="#fff">
                ...
                <g id="filled" className={animate} fill="#ffffff">
                    <rect
                        width="32.347"
                        height="193.746"
                        x="74.741"
                ...
                {/* <g fill="#fff" id="filled" className="hidden">
                    <rect
                        width="32.347"
                        height="193.746"
                        x="94.741"
