...
export default function AboutMe() {
    return(
        <Container className="flex-col md:flex-row p-10 bg-black">
                <div className="flex flex-row items-center justify-center logo py-24 md:w-1/3">
                    <LogoLined className="md:h-24 h-32" />
                </div>
                <div className="text-white text-lg font-light text-justify md:w-1/2">
