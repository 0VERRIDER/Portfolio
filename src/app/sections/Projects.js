                ...
                <div className="grid grid-cols-1 md:grid-cols-2 w-full gap-5 px-5 md:px-20  justify-center items-center ">
                    {
                        projects.map((project, index) => {
                            return (
                                <div key={index} className={` flex flex-row bg-gradient-to-r  h-32 w-full from-black ${project.color || "to-primary"} border border-white hover:border-2 transition-all rounded-lg`}>
                                    ...
                                    <div className={`flex flex-col justify-center items-end px-10 w-1/2`}>
